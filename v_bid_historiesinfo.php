...
$v_bid_histories = NULL;

//
// Table class for v_bid_histories
//
class cv_bid_histories extends cTable {
	var $auc_date;
	var $auc_number;
	var $lot_number;
	var $chop;
	...
	function __construct() {
		...
		$this->TableVar = 'v_bid_histories';
		$this->TableName = 'v_bid_histories';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_bid_histories`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// auc_date
		$this->auc_date = new cField('v_bid_histories', 'v_bid_histories', 'x_auc_date', 'auc_date', '`auc_date`', ew_CastDateFieldForLike('`auc_date`', 0, "DB"), 133, 0, FALSE, '`auc_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// auc_number
		$this->auc_number = new cField('v_bid_histories', 'v_bid_histories', 'x_auc_number', 'auc_number', '`auc_number`', '`auc_number`', 200, -1, FALSE, '`auc_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->auc_number->Sortable = FALSE; // Allow sort
		$this->fields['auc_number'] = &$this->auc_number;

		// lot_number
		$this->lot_number = new cField('v_bid_histories', 'v_bid_histories', 'x_lot_number', 'lot_number', '`lot_number`', '`lot_number`', 3, -1, FALSE, '`lot_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lot_number->Sortable = FALSE; // Allow sort
		$this->lot_number->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['lot_number'] = &$this->lot_number;

		// chop
		$this->chop = new cField('v_bid_histories', 'v_bid_histories', 'x_chop', 'chop', '`chop`', '`chop`', 200, -1, FALSE, '`chop`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->chop->Sortable = FALSE; // Allow sort
		$this->fields['chop'] = &$this->chop;

		// grade
		$this->grade = new cField('v_bid_histories', 'v_bid_histories', 'x_grade', 'grade', '`grade`', '`grade`', 200, -1, FALSE, '`grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->grade->Sortable = FALSE; // Allow sort
		$this->fields['grade'] = &$this->grade;

		// sack
		$this->sack = new cField('v_bid_histories', 'v_bid_histories', 'x_sack', 'sack', '`sack`', '`sack`', 3, -1, FALSE, '`sack`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sack->Sortable = FALSE; // Allow sort
		$this->sack->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['sack'] = &$this->sack;

		// netto
		$this->netto = new cField('v_bid_histories', 'v_bid_histories', 'x_netto', 'netto', '`netto`', '`netto`', 5, -1, FALSE, '`netto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// currency
		$this->currency = new cField('v_bid_histories', 'v_bid_histories', 'x_currency', 'currency', '`currency`', '`currency`', 200, -1, FALSE, '`currency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// bid_time
		$this->bid_time = new cField('v_bid_histories', 'v_bid_histories', 'x_bid_time', 'bid_time', '`bid_time`', ew_CastDateFieldForLike('`bid_time`', 11, "DB"), 135, 11, FALSE, '`bid_time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bid_value
		$this->bid_value = new cField('v_bid_histories', 'v_bid_histories', 'x_bid_value', 'bid_value', '`bid_value`', '`bid_value`', 5, -1, FALSE, '`bid_value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bid_value->Sortable = FALSE; // Allow sort
		$this->bid_value->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['bid_value'] = &$this->bid_value;

		// user_id
		$this->user_id = new cField('v_bid_histories', 'v_bid_histories', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->Sortable = FALSE; // Allow sort
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// sold_bid
		$this->sold_bid = new cField('v_bid_histories', 'v_bid_histories', 'x_sold_bid', 'sold_bid', '`sold_bid`', '`sold_bid`', 5, -1, FALSE, '`sold_bid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sold_bid->Sortable = FALSE; // Allow sort
		$this->sold_bid->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['sold_bid'] = &$this->sold_bid;

		// winner_id
		$this->winner_id = new cField('v_bid_histories', 'v_bid_histories', 'x_winner_id', 'winner_id', '`winner_id`', '`winner_id`', 3, -1, FALSE, '`winner_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->winner_id->Sortable = FALSE; // Allow sort
		...
		// row_id
		$this->row_id = new cField('v_bid_histories', 'v_bid_histories', 'x_row_id', 'row_id', '`row_id`', '`row_id`', 3, -1, FALSE, '`row_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// master_id
		$this->master_id = new cField('v_bid_histories', 'v_bid_histories', 'x_master_id', 'master_id', '`master_id`', '`master_id`', 3, -1, FALSE, '`master_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_bid_histories`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_bid_historieslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "v_bid_historiesview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "v_bid_historiesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "v_bid_historiesadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_bid_historiesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_bid_historiesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_bid_historiesadd.php?" . $this->UrlParm($parm);
		else
			$url = "v_bid_historiesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_bid_historiesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_bid_historiesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_bid_historiesdelete.php", $this->UrlParm());
	}
	...
	// Common render codes
		...
		$this->winner_id->CellCssStyle .= "text-align: left;";
	...
	function RenderEditRow() {
		...
		$this->auc_date->EditValue = ew_FormatDateTime($this->auc_date->CurrentValue, 8);
		...
		if (strval($this->sold_bid->EditValue) <> "" && is_numeric($this->sold_bid->EditValue)) $this->sold_bid->EditValue = ew_FormatNumber($this->sold_bid->EditValue, -2, -2, -2, -2);
	...
	function Recordset_Selecting(&$filter) {
		...
		ew_AddFilter($filter, "user_id = '".CurrentUserID()."'"); 
	}
