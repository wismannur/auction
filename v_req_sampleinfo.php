...
//
// Table class for v_req_sample
//
class cv_req_sample extends cTable {
	var $req_date;
	var $FullName;
	var $auc_number;
	var $lot_number;
	...
	function __construct() {
		...
		$this->TableVar = 'v_req_sample';
		$this->TableName = 'v_req_sample';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_req_sample`";
		$this->DBID = 'DB';
		...
		// req_date
		$this->req_date = new cField('v_req_sample', 'v_req_sample', 'x_req_date', 'req_date', '`req_date`', ew_CastDateFieldForLike('`req_date`', 2, "DB"), 135, 2, FALSE, '`req_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FullName
		$this->FullName = new cField('v_req_sample', 'v_req_sample', 'x_FullName', 'FullName', '`FullName`', '`FullName`', 200, -1, FALSE, '`FullName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FullName->Sortable = TRUE; // Allow sort
		$this->fields['FullName'] = &$this->FullName;

		// auc_number
		$this->auc_number = new cField('v_req_sample', 'v_req_sample', 'x_auc_number', 'auc_number', '`auc_number`', '`auc_number`', 200, -1, FALSE, '`auc_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->auc_number->Sortable = TRUE; // Allow sort
		$this->fields['auc_number'] = &$this->auc_number;

		// lot_number
		$this->lot_number = new cField('v_req_sample', 'v_req_sample', 'x_lot_number', 'lot_number', '`lot_number`', '`lot_number`', 3, -1, FALSE, '`lot_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// chop
		$this->chop = new cField('v_req_sample', 'v_req_sample', 'x_chop', 'chop', '`chop`', '`chop`', 200, -1, FALSE, '`chop`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->chop->Sortable = TRUE; // Allow sort
		$this->fields['chop'] = &$this->chop;

		// grade
		$this->grade = new cField('v_req_sample', 'v_req_sample', 'x_grade', 'grade', '`grade`', '`grade`', 200, -1, FALSE, '`grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->grade->Sortable = TRUE; // Allow sort
		$this->fields['grade'] = &$this->grade;

		// estate
		$this->estate = new cField('v_req_sample', 'v_req_sample', 'x_estate', 'estate', '`estate`', '`estate`', 200, -1, FALSE, '`estate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->estate->Sortable = TRUE; // Allow sort
		$this->fields['estate'] = &$this->estate;

		// sent_date
		$this->sent_date = new cField('v_req_sample', 'v_req_sample', 'x_sent_date', 'sent_date', '`sent_date`', ew_CastDateFieldForLike('`sent_date`', 0, "DB"), 133, 0, FALSE, '`sent_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sudah_dikirim
		$this->sudah_dikirim = new cField('v_req_sample', 'v_req_sample', 'x_sudah_dikirim', 'sudah_dikirim', '`sudah_dikirim`', '`sudah_dikirim`', 202, -1, FALSE, '`sudah_dikirim`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->sudah_dikirim->Sortable = FALSE; // Allow sort
		...
		// row_id
		$this->row_id = new cField('v_req_sample', 'v_req_sample', 'x_row_id', 'row_id', '`row_id`', '`row_id`', 3, -1, FALSE, '`row_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_req_sample`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`req_date` DESC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "v_req_sampleedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "v_req_sampleadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_req_sampleview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_req_sampleview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_req_sampleadd.php?" . $this->UrlParm($parm);
		else
			$url = "v_req_sampleadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_req_sampleedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_req_sampleadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_req_sampledelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->sent_date->EditValue = ew_FormatDateTime($this->sent_date->CurrentValue, 8);
