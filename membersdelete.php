...
$members_delete = NULL; // Initialize page object first

class cmembers_delete extends cmembers {
	...
	function Page_Main() {
		...
		if ($this->Recordset = ew_LoadRecordset($sql, $conn)) {
			...
			if (!$res) $this->Page_Terminate("memberslist.php"); // Return to list
		}
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				if ($this->Recordset)
					$this->Recordset->Close();
				$this->Page_Terminate("memberslist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($members_delete)) $members_delete = new cmembers_delete();
...
var CurrentForm = fmembersdelete = new ew_Form("fmembersdelete", "delete");

// Form_CustomValidate event
fmembersdelete.Form_CustomValidate = 
...
fmembersdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmembersdelete.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fmembersdelete.Lists["x_UserLevel"].Data = "<?php echo $members_delete->UserLevel->LookupFilterQuery(FALSE, "delete") ?>";
fmembersdelete.Lists["x_Activated[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmembersdelete.Lists["x_Activated[]"].Options = <?php echo json_encode($members_delete->Activated->Options()) ?>;
...
?>
<form name="fmembersdelete" id="fmembersdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($members_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $members_delete->Token ?>">
<?php } ?>
...
<?php if ($members->Username->Visible) { // Username ?>
		<th class="<?php echo $members->Username->HeaderCellClass() ?>"><span id="elh_members_Username" class="members_Username"><?php echo $members->Username->FldCaption() ?></span></th>
<?php } ?>
<?php if ($members->UserLevel->Visible) { // UserLevel ?>
		<th class="<?php echo $members->UserLevel->HeaderCellClass() ?>"><span id="elh_members_UserLevel" class="members_UserLevel"><?php echo $members->UserLevel->FldCaption() ?></span></th>
<?php } ?>
<?php if ($members->FullName->Visible) { // FullName ?>
		<th class="<?php echo $members->FullName->HeaderCellClass() ?>"><span id="elh_members_FullName" class="members_FullName"><?php echo $members->FullName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($members->CompanyName->Visible) { // CompanyName ?>
		<th class="<?php echo $members->CompanyName->HeaderCellClass() ?>"><span id="elh_members_CompanyName" class="members_CompanyName"><?php echo $members->CompanyName->FldCaption() ?></span></th>
<?php } ?>
<?php if ($members->_Email->Visible) { // Email ?>
		<th class="<?php echo $members->_Email->HeaderCellClass() ?>"><span id="elh_members__Email" class="members__Email"><?php echo $members->_Email->FldCaption() ?></span></th>
<?php } ?>
<?php if ($members->Activated->Visible) { // Activated ?>
		<th class="<?php echo $members->Activated->HeaderCellClass() ?>"><span id="elh_members_Activated" class="members_Activated"><?php echo $members->Activated->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $members_delete->RowCnt ?>_members_Username" class="members_Username">
...
<span id="el<?php echo $members_delete->RowCnt ?>_members_UserLevel" class="members_UserLevel">
...
<span id="el<?php echo $members_delete->RowCnt ?>_members_FullName" class="members_FullName">
...
<span id="el<?php echo $members_delete->RowCnt ?>_members_CompanyName" class="members_CompanyName">
...
<span id="el<?php echo $members_delete->RowCnt ?>_members__Email" class="members__Email">
...
<span id="el<?php echo $members_delete->RowCnt ?>_members_Activated" class="members_Activated">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $members_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fmembersdelete.Init();
