...
<div class="panel-body" id="homeAuction"></div>
...
<?php
 ...
 ?>
	 ...
	 <?php
		  	$sql = "SELECT  " .
		  		 "`tr_home`.`wellcome_msg` AS `wellcome_msg`" .
		  	     " FROM `tr_home`" ;

		  	echo $db->ExecuteHtml($sql, array("tablename" => array("tr_home"))); 
	 ?>

	 <?php
		  	$sql = "SELECT  " .
		  		 "`tr_home`.`home_msg` AS `home_msg`" .
		  	     " FROM `tr_home`" ;
