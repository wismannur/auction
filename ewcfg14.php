...
define("EW_PROJECT_NAME", "Tea_Auction", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{DFE89B97-9D22-437D-AA4F-59294E95069A}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'YRa2mxzFTUB35d9P', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Tea_Auction.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "12345", "db" => "db_tea_auction", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "12345", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`members`", TRUE);
...
define("EW_SMTP_SERVER_USERNAME", "maulana.cmi@gmail.com", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "alwialya196871", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "maulana.cmi@gmail.com", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "maulana.cmi@gmail.com", TRUE); // Recipient email address
...
define("EW_UPLOAD_DEST_PATH", "/uploadfile/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "jpg,jpeg,bmp,png,pdf,zip", TRUE); // Allowed file extensions
