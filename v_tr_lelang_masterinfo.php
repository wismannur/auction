...
$v_tr_lelang_master = NULL;

//
// Table class for v_tr_lelang_master
//
class cv_tr_lelang_master extends cTable {
	var $row_id;
	var $auc_date;
	var $session_number;
	var $t_start_bid;
	...
	function __construct() {
		...
		$this->TableVar = 'v_tr_lelang_master';
		$this->TableName = 'v_tr_lelang_master';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_tr_lelang_master`";
		$this->DBID = 'DB';
		...
		// row_id
		$this->row_id = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_row_id', 'row_id', '`row_id`', '`row_id`', 3, -1, FALSE, '`row_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		...
		// auc_date
		$this->auc_date = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_auc_date', 'auc_date', '`auc_date`', ew_CastDateFieldForLike('`auc_date`', 11, "DB"), 133, 11, FALSE, '`auc_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// session_number
		$this->session_number = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_session_number', 'session_number', '`session_number`', '`session_number`', 200, -1, FALSE, '`session_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->session_number->Sortable = TRUE; // Allow sort
		$this->fields['session_number'] = &$this->session_number;

		// t_start_bid
		$this->t_start_bid = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_t_start_bid', 't_start_bid', '`t_start_bid`', ew_CastDateFieldForLike('`t_start_bid`', 3, "DB"), 134, 3, FALSE, '`t_start_bid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->t_start_bid->Sortable = TRUE; // Allow sort
		$this->t_start_bid->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_TIME_SEPARATOR"], $Language->Phrase("IncorrectTime"));
		$this->fields['t_start_bid'] = &$this->t_start_bid;

		// t_close_bid
		$this->t_close_bid = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_t_close_bid', 't_close_bid', '`t_close_bid`', ew_CastDateFieldForLike('`t_close_bid`', 3, "DB"), 134, 3, FALSE, '`t_close_bid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->t_close_bid->Sortable = TRUE; // Allow sort
		$this->t_close_bid->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_TIME_SEPARATOR"], $Language->Phrase("IncorrectTime"));
		$this->fields['t_close_bid'] = &$this->t_close_bid;

		// auc_number
		$this->auc_number = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_auc_number', 'auc_number', '`auc_number`', '`auc_number`', 200, -1, FALSE, '`auc_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->auc_number->Sortable = TRUE; // Allow sort
		$this->fields['auc_number'] = &$this->auc_number;

		// start_bid
		$this->start_bid = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_start_bid', 'start_bid', '`start_bid`', ew_CastDateFieldForLike('`start_bid`', 10, "DB"), 135, 10, FALSE, '`start_bid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->start_bid->Sortable = TRUE; // Allow sort
		$this->start_bid->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateMDY"));
		$this->fields['start_bid'] = &$this->start_bid;

		// close_bid
		$this->close_bid = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_close_bid', 'close_bid', '`close_bid`', ew_CastDateFieldForLike('`close_bid`', 10, "DB"), 135, 10, FALSE, '`close_bid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->close_bid->Sortable = TRUE; // Allow sort
		$this->close_bid->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateMDY"));
		$this->fields['close_bid'] = &$this->close_bid;

		// auc_place
		$this->auc_place = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_auc_place', 'auc_place', '`auc_place`', '`auc_place`', 200, -1, FALSE, '`auc_place`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->auc_place->Sortable = TRUE; // Allow sort
		$this->fields['auc_place'] = &$this->auc_place;

		// auc_notes
		$this->auc_notes = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_auc_notes', 'auc_notes', '`auc_notes`', '`auc_notes`', 200, -1, FALSE, '`auc_notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->auc_notes->Sortable = TRUE; // Allow sort
		$this->fields['auc_notes'] = &$this->auc_notes;

		// total_sack
		$this->total_sack = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_total_sack', 'total_sack', '`total_sack`', '`total_sack`', 3, -1, FALSE, '`total_sack`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total_sack->Sortable = TRUE; // Allow sort
		$this->total_sack->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['total_sack'] = &$this->total_sack;

		// total_netto
		$this->total_netto = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_total_netto', 'total_netto', '`total_netto`', '`total_netto`', 5, -1, FALSE, '`total_netto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total_netto->Sortable = TRUE; // Allow sort
		$this->total_netto->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['total_netto'] = &$this->total_netto;

		// total_gross
		$this->total_gross = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_total_gross', 'total_gross', '`total_gross`', '`total_gross`', 5, -1, FALSE, '`total_gross`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total_gross->Sortable = TRUE; // Allow sort
		$this->total_gross->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['total_gross'] = &$this->total_gross;

		// btn_cetak_catalog
		$this->btn_cetak_catalog = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_btn_cetak_catalog', 'btn_cetak_catalog', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->btn_cetak_catalog->FldIsCustom = TRUE; // Custom field
		$this->btn_cetak_catalog->Sortable = TRUE; // Allow sort
		$this->fields['btn_cetak_catalog'] = &$this->btn_cetak_catalog;

		// auc_status
		$this->auc_status = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_auc_status', 'auc_status', '`auc_status`', '`auc_status`', 202, -1, FALSE, '`auc_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->auc_status->Sortable = TRUE; // Allow sort
		$this->fields['auc_status'] = &$this->auc_status;

		// rate
		$this->rate = new cField('v_tr_lelang_master', 'v_tr_lelang_master', 'x_rate', 'rate', '`rate`', '`rate`', 5, -1, FALSE, '`rate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "v_tr_lelang_item") {
			$sDetailUrl = $GLOBALS["v_tr_lelang_item"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_row_id=" . urlencode($this->row_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "v_tr_lelang_masterlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_tr_lelang_master`";
	}
	...
	function getSqlSelect() { // Select
		return ($this->_SqlSelect <> "") ? $this->_SqlSelect : "SELECT *, '' AS `btn_cetak_catalog` FROM " . $this->getSqlFrom();
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_tr_lelang_masterlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "v_tr_lelang_masterview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "v_tr_lelang_masteredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "v_tr_lelang_masteradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_tr_lelang_masterview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_tr_lelang_masterview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_tr_lelang_masteradd.php?" . $this->UrlParm($parm);
		else
			$url = "v_tr_lelang_masteradd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_tr_lelang_masteredit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_tr_lelang_masteredit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_tr_lelang_masteradd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_tr_lelang_masteradd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_tr_lelang_masterdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->t_start_bid->setDbValue($rs->fields('t_start_bid'));
		$this->t_close_bid->setDbValue($rs->fields('t_close_bid'));
		...
		$this->btn_cetak_catalog->setDbValue($rs->fields('btn_cetak_catalog'));
	...
	function RenderEditRow() {
		...
		$this->auc_date->EditValue = ew_FormatDateTime($this->auc_date->CurrentValue, 11);
		$this->auc_date->PlaceHolder = ew_RemoveHtml($this->auc_date->FldCaption());

		// session_number
		$this->session_number->EditAttrs["class"] = "form-control";
		$this->session_number->EditCustomAttributes = "";
		$this->session_number->EditValue = $this->session_number->CurrentValue;
		$this->session_number->PlaceHolder = ew_RemoveHtml($this->session_number->FldCaption());

		// t_start_bid
		$this->t_start_bid->EditAttrs["class"] = "form-control";
		$this->t_start_bid->EditCustomAttributes = "";
		$this->t_start_bid->EditValue = $this->t_start_bid->CurrentValue;
		$this->t_start_bid->PlaceHolder = ew_RemoveHtml($this->t_start_bid->FldCaption());

		// t_close_bid
		$this->t_close_bid->EditAttrs["class"] = "form-control";
		$this->t_close_bid->EditCustomAttributes = "";
		$this->t_close_bid->EditValue = $this->t_close_bid->CurrentValue;
		$this->t_close_bid->PlaceHolder = ew_RemoveHtml($this->t_close_bid->FldCaption());
		...
		$this->start_bid->EditValue = ew_FormatDateTime($this->start_bid->CurrentValue, 10);
		...
		$this->close_bid->EditValue = ew_FormatDateTime($this->close_bid->CurrentValue, 10);
		...
		$this->total_netto->EditValue = $this->total_netto->CurrentValue;
		$this->total_netto->PlaceHolder = ew_RemoveHtml($this->total_netto->FldCaption());
		if (strval($this->total_netto->EditValue) <> "" && is_numeric($this->total_netto->EditValue)) $this->total_netto->EditValue = ew_FormatNumber($this->total_netto->EditValue, -2, -2, -2, -2);
		...
		// btn_cetak_catalog
		$this->btn_cetak_catalog->EditAttrs["class"] = "form-control";
		$this->btn_cetak_catalog->EditCustomAttributes = "";
		$this->btn_cetak_catalog->EditValue = $this->btn_cetak_catalog->CurrentValue;
		$this->btn_cetak_catalog->PlaceHolder = ew_RemoveHtml($this->btn_cetak_catalog->FldCaption());

		// auc_status
		$this->auc_status->EditAttrs["class"] = "form-control";
		$this->auc_status->EditCustomAttributes = "";
		$this->auc_status->EditValue = $this->auc_status->CurrentValue;
		$this->auc_status->PlaceHolder = ew_RemoveHtml($this->auc_status->FldCaption());
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->btn_cetak_catalog->Exportable) $Doc->ExportCaption($this->btn_cetak_catalog);
					...
					if ($this->session_number->Exportable) $Doc->ExportCaption($this->session_number);
					if ($this->t_start_bid->Exportable) $Doc->ExportCaption($this->t_start_bid);
					if ($this->t_close_bid->Exportable) $Doc->ExportCaption($this->t_close_bid);
					if ($this->auc_number->Exportable) $Doc->ExportCaption($this->auc_number);
					if ($this->start_bid->Exportable) $Doc->ExportCaption($this->start_bid);
					if ($this->close_bid->Exportable) $Doc->ExportCaption($this->close_bid);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->btn_cetak_catalog->Exportable) $Doc->ExportField($this->btn_cetak_catalog);
						...
						if ($this->session_number->Exportable) $Doc->ExportField($this->session_number);
						if ($this->t_start_bid->Exportable) $Doc->ExportField($this->t_start_bid);
						if ($this->t_close_bid->Exportable) $Doc->ExportField($this->t_close_bid);
						if ($this->auc_number->Exportable) $Doc->ExportField($this->auc_number);
						if ($this->start_bid->Exportable) $Doc->ExportField($this->start_bid);
						if ($this->close_bid->Exportable) $Doc->ExportField($this->close_bid);
