...
$log_lastbid_view = NULL; // Initialize page object first

class clog_lastbid_view extends clog_lastbid {
	...
	// Page object name
	var $PageObjName = 'log_lastbid_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["last_row_id"] <> "") {
			$this->RecKey["last_row_id"] = $_GET["last_row_id"];
			$KeyUrl .= "&amp;last_row_id=" . urlencode($this->RecKey["last_row_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["last_row_id"] <> "") {
				...
				$this->RecKey["last_row_id"] = $this->last_row_id->QueryStringValue;
			} elseif (@$_POST["last_row_id"] <> "") {
				$this->last_row_id->setFormValue($_POST["last_row_id"]);
				$this->RecKey["last_row_id"] = $this->last_row_id->FormValue;
			} else {
				$sReturnUrl = "log_lastbidlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "log_lastbidlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "log_lastbidlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($log_lastbid_view)) $log_lastbid_view = new clog_lastbid_view();

// Page init
$log_lastbid_view->Page_Init();

// Page main
$log_lastbid_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$log_lastbid_view->Page_Render();
?>
...
var CurrentForm = flog_lastbidview = new ew_Form("flog_lastbidview", "view");

// Form_CustomValidate event
flog_lastbidview.Form_CustomValidate = 
...
flog_lastbidview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $log_lastbid_view->ExportOptions->Render("body") ?>
<?php
	foreach ($log_lastbid_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $log_lastbid_view->ShowPageHeader(); ?>
<?php
$log_lastbid_view->ShowMessage();
?>
<form name="flog_lastbidview" id="flog_lastbidview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($log_lastbid_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $log_lastbid_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="log_lastbid">
<input type="hidden" name="modal" value="<?php echo intval($log_lastbid_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($log_lastbid->last_row_id->Visible) { // last_row_id ?>
	<tr id="r_last_row_id">
		<td class="col-sm-2"><span id="elh_log_lastbid_last_row_id"><?php echo $log_lastbid->last_row_id->FldCaption() ?></span></td>
...
<?php echo $log_lastbid->last_row_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $log_lastbid->last_user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $log_lastbid->last_bid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $log_lastbid->last_time->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
flog_lastbidview.Init();
</script>
<?php
$log_lastbid_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$log_lastbid_view->Page_Terminate();
?>
