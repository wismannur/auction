...
$members_view = NULL; // Initialize page object first

class cmembers_view extends cmembers {
...
// Create page object
if (!isset($members_view)) $members_view = new cmembers_view();
...
var CurrentForm = fmembersview = new ew_Form("fmembersview", "view");

// Form_CustomValidate event
fmembersview.Form_CustomValidate = 
...
fmembersview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmembersview.Lists["x_Activated[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmembersview.Lists["x_Activated[]"].Options = <?php echo json_encode($members_view->Activated->Options()) ?>;
...
<?php
	foreach ($members_view->OtherOptions as &$option)
		$option->Render("body");
?>
...
?>
<form name="fmembersview" id="fmembersview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($members_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $members_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="members">
<input type="hidden" name="modal" value="<?php echo intval($members_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($members->user_id->Visible) { // user_id ?>
	<tr id="r_user_id">
		<td class="col-sm-2"><span id="elh_members_user_id"><?php echo $members->user_id->FldCaption() ?></span></td>
		<td data-name="user_id"<?php echo $members->user_id->CellAttributes() ?>>
<span id="el_members_user_id">
<span<?php echo $members->user_id->ViewAttributes() ?>>
<?php echo $members->user_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($members->Username->Visible) { // Username ?>
	<tr id="r_Username">
		<td class="col-sm-2"><span id="elh_members_Username"><?php echo $members->Username->FldCaption() ?></span></td>
...
<?php echo $members->Username->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($members->Photo->Visible) { // Photo ?>
	<tr id="r_Photo">
		...
		<td data-name="Photo"<?php echo $members->Photo->CellAttributes() ?>>
<span id="el_members_Photo">
<span<?php echo $members->Photo->ViewAttributes() ?>>
<?php echo $members->Photo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($members->Password->Visible) { // Password ?>
	<tr id="r_Password">
		<td class="col-sm-2"><span id="elh_members_Password"><?php echo $members->Password->FldCaption() ?></span></td>
		<td data-name="Password"<?php echo $members->Password->CellAttributes() ?>>
<span id="el_members_Password">
<span<?php echo $members->Password->ViewAttributes() ?>>
<?php echo $members->Password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $members->FullName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $members->CompanyName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($members->Address->Visible) { // Address ?>
	<tr id="r_Address">
		...
		<td data-name="Address"<?php echo $members->Address->CellAttributes() ?>>
<span id="el_members_Address">
<span<?php echo $members->Address->ViewAttributes() ?>>
<?php echo $members->Address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($members->Title->Visible) { // Title ?>
	<tr id="r_Title">
		...
		<td data-name="Title"<?php echo $members->Title->CellAttributes() ?>>
<span id="el_members_Title">
<span<?php echo $members->Title->ViewAttributes() ?>>
<?php echo $members->Title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $members->_Email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $members->UserLevel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<input type="checkbox" value="<?php echo $members->Activated->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $members->Activated->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($members->profile->Visible) { // profile ?>
	<tr id="r_profile">
		...
		<td data-name="profile"<?php echo $members->profile->CellAttributes() ?>>
<span id="el_members_profile">
<span<?php echo $members->profile->ViewAttributes() ?>>
<?php echo $members->profile->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
