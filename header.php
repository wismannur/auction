...
<?php
ew_AddStyleSheet("phpcss/customcss/custom_auction.css");
ew_AddStyleSheet("phpcss/customcss/toastr.css");
ew_AddStyleSheet("phpcss/customcss/preloading_screen.css");
ew_AddClientScript("phpjs/customjs/global_auction.js");
ew_AddClientScript("phpjs/customjs/mqttws31.min.js");
ew_AddClientScript("phpjs/customjs/toastr.js");
?>
...
<div class="wrapper ewLayout">
	...
	<header class="main-header">
		<div class="logo">
			...
			<span class="logo-lg"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/logo.jpg" alt=""></span>
		</div>
		<!-- Header Navbar -->
