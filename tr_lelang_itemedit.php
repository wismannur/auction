...
$tr_lelang_item_edit = NULL; // Initialize page object first

class ctr_lelang_item_edit extends ctr_lelang_item {
	...
	// Page object name
	var $PageObjName = 'tr_lelang_item_edit';
...
// Create page object
if (!isset($tr_lelang_item_edit)) $tr_lelang_item_edit = new ctr_lelang_item_edit();

// Page init
$tr_lelang_item_edit->Page_Init();

// Page main
$tr_lelang_item_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tr_lelang_item_edit->Page_Render();
?>
...
var CurrentForm = ftr_lelang_itemedit = new ew_Form("ftr_lelang_itemedit", "edit");

// Validate form
ftr_lelang_itemedit.Validate = function() {
...
ftr_lelang_itemedit.Form_CustomValidate = 
...
ftr_lelang_itemedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftr_lelang_itemedit.Lists["x_currency"] = {"LinkField":"x_id_cur","Ajax":true,"AutoFill":true,"DisplayFields":["x_currency","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tbl_currency"};
ftr_lelang_itemedit.Lists["x_currency"].Data = "<?php echo $tr_lelang_item_edit->currency->LookupFilterQuery(FALSE, "edit") ?>";
ftr_lelang_itemedit.Lists["x_auction_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftr_lelang_itemedit.Lists["x_auction_status"].Options = <?php echo json_encode($tr_lelang_item_edit->auction_status->Options()) ?>;
...
<?php $tr_lelang_item_edit->ShowPageHeader(); ?>
<?php
$tr_lelang_item_edit->ShowMessage();
?>
<form name="ftr_lelang_itemedit" id="ftr_lelang_itemedit" class="<?php echo $tr_lelang_item_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tr_lelang_item_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tr_lelang_item_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tr_lelang_item">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tr_lelang_item_edit->IsModal) ?>">
...
<?php } ?>
<?php if (!$tr_lelang_item_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_tr_lelang_itemedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($tr_lelang_item->lot_number->Visible) { // lot_number ?>
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_lot_number" class="form-group">
		<label id="elh_tr_lelang_item_lot_number" for="x_lot_number" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->lot_number->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->lot_number->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_chop" class="form-group">
		<label id="elh_tr_lelang_item_chop" for="x_chop" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->chop->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->chop->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_estate" class="form-group">
		<label id="elh_tr_lelang_item_estate" for="x_estate" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->estate->FldCaption() ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->estate->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_grade" class="form-group">
		<label id="elh_tr_lelang_item_grade" for="x_grade" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->grade->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->grade->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_jenis" class="form-group">
		<label id="elh_tr_lelang_item_jenis" for="x_jenis" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->jenis->FldCaption() ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->jenis->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_sack" class="form-group">
		<label id="elh_tr_lelang_item_sack" for="x_sack" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->sack->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->sack->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_netto" class="form-group">
		<label id="elh_tr_lelang_item_netto" for="x_netto" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->netto->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->netto->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_gross" class="form-group">
		<label id="elh_tr_lelang_item_gross" for="x_gross" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->gross->FldCaption() ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->gross->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_open_bid" class="form-group">
		<label id="elh_tr_lelang_item_open_bid" for="x_open_bid" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->open_bid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->open_bid->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_currency" class="form-group">
		<label id="elh_tr_lelang_item_currency" for="x_currency" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->currency->FldCaption() ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->currency->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_bid_step" class="form-group">
		<label id="elh_tr_lelang_item_bid_step" for="x_bid_step" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->bid_step->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->bid_step->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_rate" class="form-group">
		<label id="elh_tr_lelang_item_rate" for="x_rate" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->rate->FldCaption() ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->rate->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_proforma_number" class="form-group">
		<label id="elh_tr_lelang_item_proforma_number" for="x_proforma_number" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->proforma_number->FldCaption() ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->proforma_number->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_proforma_amount" class="form-group">
		<label id="elh_tr_lelang_item_proforma_amount" for="x_proforma_amount" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->proforma_amount->FldCaption() ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->proforma_amount->CellAttributes() ?>>
...
<?php if ($tr_lelang_item_edit->IsMobileOrModal) { ?>
	<div id="r_auction_status" class="form-group">
		<label id="elh_tr_lelang_item_auction_status" for="x_auction_status" class="<?php echo $tr_lelang_item_edit->LeftColumnClass ?>"><?php echo $tr_lelang_item->auction_status->FldCaption() ?></label>
		<div class="<?php echo $tr_lelang_item_edit->RightColumnClass ?>"><div<?php echo $tr_lelang_item->auction_status->CellAttributes() ?>>
...
<?php } ?>
<input type="hidden" data-table="tr_lelang_item" data-field="x_row_id" name="x_row_id" id="x_row_id" value="<?php echo ew_HtmlEncode($tr_lelang_item->row_id->CurrentValue) ?>">
<?php if (!$tr_lelang_item_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $tr_lelang_item_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tr_lelang_item_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
ftr_lelang_itemedit.Init();
</script>
<?php
$tr_lelang_item_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tr_lelang_item_edit->Page_Terminate();
?>
